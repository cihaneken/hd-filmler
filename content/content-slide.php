...
<article id="post-<?php the_ID(); ?>" <?php post_class('article-home'); ?>>
	<div class="post-slide  bg-white card my-3 mx-auto">
	<div class="post-thumbnail card-img-top">
          <?php if ( has_post_thumbnail() ) { the_post_thumbnail('slide-thumbnail' ,array('class' => 'img-fluid entry-thumbnail')); } else { echo '';
					} ?>
        </div>
    ...
    echo esc_html( $term_list[0]->name ) ;
		...
		<div class="card-lang-slide position-absolute">
    ...
    echo esc_html( $term_list[0]->name ) ;
		...
		<div class="card-size-slide position-absolute">
    ...
    echo esc_html( $term_list[0]->name ) ;
		...
		<div class="card-hover-slide position-absolute text-center"><i class="far fa-play-circle"></i></div>
</article>
</a>
</div>